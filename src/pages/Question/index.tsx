        ...
        {!isObjectEmpty(question) ? (
          <div>
            <div className="question-main-header Card">
              ...
              <div className="main-header-r">关注者</div>
            </div>
            <div className="question-main-body">
                    ...
                    {answers.map(
                      (answer: any, index: React.Key | null | undefined) => {
                        return (
                          <div
                            key={index}
                            className="question-main-body-l-body Card"
                          >
                            ...
                            <span className="question-section-like">
                              {answer.agreeCount} 人赞同了该回答
                            </span>
              ...
              <div className="question-main-body-r">
                <div className="question-main-body-r-ad">广告</div>
                <div className="question-main-body-r-author Card">关于作者</div>
                <div className="question-main-body-r- Card">被收藏</div>
                <div className="question-main-body-r- Card">相关问题</div>
                <div className="question-main-body-r- Card">相关推荐</div>
                <div className="question-main-body-r-ad">广告</div>
              </div>
            </div>
          </div>
