...
const Side = () => {
    return (
        <div className="bd-r">
                        ...
                        <button>
                            <svg width="40" height="40" viewBox="0 0 40 40" className="GlobalWriteV2-navIcon" fill="currentColor">
                                <g fill="#26BFBF" fillRule="evenodd">
                                    <circle cx="20" cy="20" r="20" opacity=".12"></circle>
                                    <path d="M21.987 11.686v2.169h-6.125c-1.43 0-1.863.064-2.297.306-.332.128-.574.383-.74.702-.255.447-.332.893-.332 2.297v7.018c0 1.442.09 1.876.332 2.297.166.345.408.587.74.766.434.23.868.319 2.297.319h7.018c1.43 0 1.863-.077 2.297-.32.345-.165.587-.408.766-.74.216-.408.296-.816.305-2.054l.001-6.316.025.025h2.17v6.074c0 1.914-.217 2.616-.587 3.318a3.92 3.92 0 01-1.634 1.62c-.689.383-1.403.575-3.317.575h-7.018c-1.915 0-2.616-.204-3.318-.575a3.891 3.891 0 01-1.62-1.62c-.384-.702-.575-1.404-.575-3.318v-7.018c0-1.914.204-2.629.574-3.318a3.996 3.996 0 011.62-1.633c.703-.383 1.404-.574 3.318-.574h6.1zm1.889 6.954c1.059 1.06 1.059 2.807 0 3.88l-.039.038a2.719 2.719 0 01-3.879 0l-2.45-2.553a.801.801 0 00-1.123 0l-.05.052c-.32.357-.32.893 0 1.212a.75.75 0 00.726.217c.51-.128 1.047.23 1.149.74a.946.946 0 01-.727 1.148 2.649 2.649 0 01-2.527-.74 2.796 2.796 0 010-3.905l.038-.025c1.098-1.085 2.808-1.085 3.892 0l2.463 2.488a.764.764 0 001.11 0l.038-.025a.855.855 0 000-1.187.876.876 0 00-.74-.217c-.51.128-1.02-.204-1.148-.727-.128-.51.204-1.021.727-1.149l.013-.013a2.703 2.703 0 012.527.766zm4.338-9.315v2.578h2.578v1.722h-2.578v2.59h-1.723v-2.602h-2.59v-1.71h2.59V9.325h1.723z" fillRule="nonzero"></path>
                                </g></svg>
                            <div className="table-body-unit-title">写想法</div>
                        </button>
                    </div>
                </div>
                <div className="creator-table-slider">
                    <div className="table-slider-unit table-slider-meta">
                        <div className="slider-meta-left">
                            <div className="slider-meta-header">今日阅读(播放)数</div>
                            <div className="slider-meta-body">0</div>
                            <div className="slider-meta-footer">昨日数据0</div>
                        </div>
                        <div className="slider-meta-right">
                            <div className="slider-meta-header">今日赞同数</div>
                            <div className="slider-meta-body">0</div>
                            <div className="slider-meta-footer">昨日数据0</div>
                        </div>
                    </div>
                    <div className="table-slider-unit table-slider-AD">
                        <div className="slider-AD-left">
                            <div className="slider-AD-title">《创作者》独家分享第二课：内容创作的价值</div>
                            <div className="slider-AD-meta"></div>
                        </div>
                        <div className="slider-AD-right">
                            <div className="slider-AD-right-mask">
                                <span className="slider-AD-right-mask-round">
                                    <span className="slider-AD-right-mask-triangle"></span>
                                </span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="creator-table-footer">
                    <button>进入创作中心</button>
                </div>
            </div>
            <div className="user-side user-side-bar">
                <div className="user-side-bar-unit side-bar-live">
                    ...
                    <div className="user-side-bar-unit-title side-bar-live-title">Live</div>
                </div>
                <div className="user-side-bar-unit side-bar-ebook">
                    ...
                    <div className="user-side-bar-unit-title side-bar-ebook-title">书店</div>
                </div>
                <div className="user-side-bar-unit side-bar-org">
                    ...
                    <div className="user-side-bar-unit-title side-bar-org-title">圆桌</div>
                </div>
                <div className="user-side-bar-unit side-bar-edit">
                    ...
                    <div className="user-side-bar-unit-title side-bar-edit-title">专栏</div>
                </div>
                <div className="user-side-bar-unit side-bar-infinity">
                    ...
                    <div className="user-side-bar-unit-title side-bar-infinity-title">付费咨询</div>
                </div>
                <div className="user-side-bar-unit side-bar-knowledgeBase">
                    ...
                    <div className="user-side-bar-unit-title side-bar-knowledgeBase-title">百科</div>
                </div>
            </div>
            <div className="user-side-AD">
                广告广告
            </div>
            <div className="user-side user-side-nav">
                <ul>
                    <li>
                        <svg className="Zi Zi--Star GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M5.515 19.64l.918-5.355-3.89-3.792c-.926-.902-.639-1.784.64-1.97L8.56 7.74l2.404-4.871c.572-1.16 1.5-1.16 2.072 0L15.44 7.74l5.377.782c1.28.186 1.566 1.068.64 1.97l-3.89 3.793.918 5.354c.219 1.274-.532 1.82-1.676 1.218L12 18.33l-4.808 2.528c-1.145.602-1.896.056-1.677-1.218z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">我的收藏</span>
                        <span className="side-nav-meta">0</span>
                    </li>
                    <li>
                        <svg className="Zi Zi--HelpBubble GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M5.74 4h12.52c.961 0 1.74.775 1.74 1.73V16.27c0 .955-.779 1.73-1.74 1.73h-3.825l-1.658 2.044a1 1 0 0 1-1.554 0l-1.658-2.044H5.74C4.78 18 4 17.224 4 16.27V5.73C4 4.775 4.778 4 5.74 4zM12 16a.976.976 0 0 0 .705-.287.951.951 0 0 0 .295-.712.954.954 0 0 0-.295-.714A.976.976 0 0 0 12 14a.962.962 0 0 0-.705.295A.961.961 0 0 0 11 15c0 .284.098.522.295.713A.975.975 0 0 0 12 16zm1.278-4.924a36.81 36.81 0 0 0 1.023-.975c.19-.193.354-.422.492-.688.138-.266.207-.575.207-.928 0-.448-.12-.864-.363-1.246a2.517 2.517 0 0 0-1.029-.906C13.164 6.111 12.652 6 12.072 6c-.624 0-1.17.133-1.638.399-.468.265-.824.6-1.068 1.005-.244.405-.366.804-.366 1.2 0 .19.077.368.231.531a.747.747 0 0 0 .567.246c.38 0 .638-.234.774-.703.144-.449.32-.788.528-1.019.208-.23.532-.345.972-.345.376 0 .683.114.921.342.238.229.357.51.357.841 0 .17-.039.328-.117.473a1.782 1.782 0 0 1-.288.396c-.114.118-.3.294-.555.526a9.71 9.71 0 0 0-.696.688c-.172.194-.31.418-.414.673a2.391 2.391 0 0 0-.156.906c0 .278.071.488.213.63a.716.716 0 0 0 .525.211c.4 0 .638-.216.714-.648.044-.203.077-.345.099-.426.022-.081.053-.162.093-.243.04-.081.101-.17.183-.268.082-.098.191-.21.327-.34z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">我关注的问题</span>
                        <span className="side-nav-meta">12</span>
                    </li>
                    <li>
                        <svg className="Zi Zi--Invite GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M4 10V8a1 1 0 1 1 2 0v2h2a1 1 0 0 1 0 2H6v2a1 1 0 0 1-2 0v-2H2a1 1 0 0 1 0-2h2zm10.455 2c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm-7 6c0-2.66 4.845-4 7.272-4C17.155 14 22 15.34 22 18v1.375c0 .345-.28.625-.625.625H8.08a.625.625 0 0 1-.625-.625V18z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">我的邀请</span>
                    </li>
                    <li>
                        <svg className="Zi Zi--Balance GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M19 19.5H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10.5a2 2 0 0 1-2 2zm0-12a.5.5 0 0 0-.5-.5h-13a.5.5 0 0 0-.5.5v2a.5.5 0 0 0 .5.5h3.75c1 0 1 2 2.75 2s1.75-2 2.75-2h3.75a.5.5 0 0 0 .5-.5v-2z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">我的余额</span>
                    </li>
                    <li>
                        <svg className="Zi Zi--Community GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M5.74 4h12.52c.961 0 1.74.775 1.74 1.73V16.27c0 .955-.779 1.73-1.74 1.73h-3.825l-1.658 2.044a1 1 0 0 1-1.554 0l-1.658-2.044H5.74C4.78 18 4 17.224 4 16.27V5.73C4 4.775 4.778 4 5.74 4zM7 8.98c0 .554.449.996 1.003.996h4.994A.992.992 0 0 0 14 8.981a.997.997 0 0 0-1.003-.995H8.003A.992.992 0 0 0 7 8.98zm0 4c0 .554.446.996.995.996h8.01a.993.993 0 0 0 .995-.995.993.993 0 0 0-.995-.995h-8.01A.993.993 0 0 0 7 12.98z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">站务中心</span>
                    </li>
                    <li>
                        <svg width="24" height="24" viewBox="0 0 24 24" className="GlobalSideBar-navIcon" fill="currentColor"><path d="M9 1.5c2.835 0 5.152 2.195 5.247 4.949l.003.176v.253A2.25 2.25 0 0115.75 9v2.25a2.25 2.25 0 01-1.5 2.122v.257c0 .547-.2 1.073-.557 1.482l-.102.109-1.06 1.06a.75.75 0 01-1.124-.99l.063-.07 1.06-1.061a.75.75 0 00.213-.432l.007-.098V13.5H12a.75.75 0 01-.75-.75V7.5a.75.75 0 01.75-.75h.75v-.125C12.75 4.628 11.076 3 9 3 6.98 3 5.34 4.541 5.254 6.464l-.004.286H6a.75.75 0 01.743.648l.007.102v5.25a.75.75 0 01-.648.743L6 13.5H4.5a2.25 2.25 0 01-2.245-2.096l-.005-.154V9c0-.98.626-1.814 1.5-2.122v-.253C3.75 3.79 6.105 1.5 9 1.5z" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">帮助中心</span>
                    </li>
                    <li>
                        <svg className="Zi Zi--Copyright GlobalSideBar-navIcon" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M16.517 15.815a5.871 5.871 0 0 1-4.481 2.078 5.865 5.865 0 0 1-5.859-5.857 5.865 5.865 0 0 1 5.859-5.859c1.63 0 3.204.7 4.319 1.919.085.093.24.432.209.797a1.086 1.086 0 0 1-.436.779c-.248.193-.516.29-.797.29-.402 0-.7-.198-.814-.314A3.473 3.473 0 0 0 12 8.575a3.464 3.464 0 0 0-3.46 3.461 3.464 3.464 0 0 0 3.46 3.46 3.63 3.63 0 0 0 2.654-1.181c.136-.152.458-.306.806-.306.274 0 .542.095.773.274.35.269.45.588.473.809.032.308-.072.585-.188.723m4.686-7.699C20.67 6.883 19.96 5.82 19.07 4.929c-.891-.89-1.954-1.601-3.188-2.133A9.728 9.728 0 0 0 12 2a9.733 9.733 0 0 0-3.883.796c-1.234.532-2.297 1.243-3.186 2.133-.891.891-1.602 1.954-2.134 3.187A9.713 9.713 0 0 0 2 12a9.752 9.752 0 0 0 .797 3.883c.531 1.233 1.242 2.296 2.134 3.186.89.891 1.953 1.602 3.186 2.134A9.725 9.725 0 0 0 12 22a9.72 9.72 0 0 0 3.883-.797c1.233-.532 2.296-1.243 3.188-2.134.89-.89 1.601-1.953 2.132-3.186A9.73 9.73 0 0 0 22 12a9.69 9.69 0 0 0-.797-3.884" fillRule="evenodd"></path></svg>
                        <span className="side-nav-title">版权服务中心</span>
                    </li>
                </ul>
            </div>
            <div className="user-side-AD">
            ...
            <div className="user-side-footer">
                <p>
                    <Link to="">刘看山</Link>·
                    <Link to="">知乎指南</Link>·
                    <Link to="">知乎协议</Link>·
                    <Link to="">知乎隐私保护指引</Link>
                </p>
                <p>
                    <Link to="">应用</Link>·
                    <Link to="">工作</Link>·
                ...
                <p>
                    <Link to="">侵权举报</Link>·
                    <Link to="">网上有害信息举报专区</Link>
                </p>
                <p>
                    <Link to="">京 ICP 证 110745 号</Link>
                </p>
                <p>
                    <Link to="">京 ICP 备 13052560 号 - 1</Link>
                </p>
                <p>
                    <img src="https://pic3.zhimg.com/80/v2-d0289dc0a46fc5b15b3363ffa78cf6c7.png" alt="" />
                    <Link to="">京公网安备 11010802020088 号</Link>
                </p>
                <p>互联网药品信息服务资格证书</p>
                <p>（京）- 非经营性 - 2017 - 0067违法和不良信息举报：010-82716601</p>
                <p>
                    <Link to="">儿童色情信息举报专区</Link>
                </p>
                <p>
                    <Link to="">信息安全漏洞反馈专区</Link>
                </p>
                <p>
                    <Link to="">内容从业人员违法违规行为举报：zh-ygwfwgjb@zhihu.com</Link>
                </p>
                <p>
                    <Link to="">证照中心</Link>·
